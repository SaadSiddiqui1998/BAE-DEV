...
import MarketplaceDeatils from '@/components/market-place/MarketPlaceDetails';

export default function marketplaceDeatils() {
              ...
              <div className='row'>
                {marketplace.map((item) => (
                  <div className='col-12 mb-3'>
                    <MarketplaceDeatils key={item.id} item={item} />
                  </div>
                ))}
              </div>
            </div>
