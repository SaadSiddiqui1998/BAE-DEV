...
export default function CreateModal({ onClose, onMediaUpload  }) {
        ...
        <>
            ...
            <div>
                <Modal
                    ...
                    className='user-create-live-screen-modal create-post-upload-media-modal'
                >
                    <Fade in={open}>
                        <Box sx={style}>
                            <Typography id="modal-modal-title" variant="h6" component="h2" className='text-center pt-3'>
                                Create new post
                            </Typography>
                            <hr></hr>
                            <div className='create-post-upload-media--content py-5 text-center'>
                                <div>
                                ...
                                <h2 className='py-4'>Drag photos and videos here</h2>
                                <div class="tb-container">
                                    <div class="tb-img-view">
                                        <img id="tb-image" />
                                    </div>
                                    <label for="tb-file-upload">Select from computer</label>
                                    <input type="file" id="tb-file-upload" accept="image/*,video/*" onChange={handleMediaUpload} />
                                </div>
                            </div>
                            <div className='user-profile--details-close-icon' onClick={() => onClose()}>
